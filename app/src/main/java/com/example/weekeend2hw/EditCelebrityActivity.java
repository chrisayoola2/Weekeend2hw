...
public class EditCelebrityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
            ...
            setTitle("Edit Celebrity");
            etEditCelebrity.setText(intent.getStringExtra(EXTRA_CELEBNAME));
            etCelebrityDescription.setText(intent.getStringExtra(EXTRA_CELEBDESCRIPTION));
            npFameLevel.setValue(intent.getIntExtra(EXTRA_CELEBFAMELEVEL,   1));
